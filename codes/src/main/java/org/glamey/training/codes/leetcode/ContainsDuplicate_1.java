...
public class ContainsDuplicate_1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findBySet(new int[] {1, 2, 3, 4}));
        System.out.println(findBySet(new int[] {1, 1, 1, 3, 3, 4, 3, 2, 4, 2}));
        System.out.println(findBySet(new int[] {1, 2, 3, 1}));
    }
     ...
     * @return
     */
    public static boolean findBySet(int[] nums) {
